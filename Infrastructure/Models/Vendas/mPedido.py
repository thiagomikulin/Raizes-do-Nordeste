...
class StatusPagamento(str, EnumPy):
    AGUARDANDO = "Aguardando Fechamento"
    PENDENTE = "Pendente",
    CANCELADO = "Cancelado"
    ESTORNADO = "Estornado"
    APROVADO = "Aprovado"
...
class Pedido(Base):
    ...
    def __init__(self, filial, tipoPedido, canalPedido, tipo_criador, id_criador, cliente=None, mesa=None, chamada=None, endereco = None, forma_pagamento=None):
        self.filial = filial
        self.status = StatusCode.ABERTO
        self.tipo = tipoPedido
        self.canal = canalPedido
