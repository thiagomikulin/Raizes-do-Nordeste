...
2. Após realizar a alteração, na pasta do projeto no terminal, executar em algum terminal dentro da pasta principal do projeto:  alembic -c Infrastructure/alembic.ini revision --autogenerate -m "Mensagem"
